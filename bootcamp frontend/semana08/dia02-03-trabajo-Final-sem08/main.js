...
const renderDragon = (dragons = []) => {
    const dragonsList = document.querySelector('#dragonList'); // Asegúrate que este ID existe en tu HTML
    let elements = '';
    ...
    document.querySelector('#numberDragons').textContent = `Favorites: ${dragonFavorites.length}`
};
