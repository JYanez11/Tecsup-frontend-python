...
const App = () => {
  ...
  // 1. Petición a Supabase para eliminar el registro
  ...
  if (error) {
    console.error('Error eliminando la película:', error.message)
    return
  }

  // 2. Actualizar el estado local para que desaparezca de la lista sin recargar
